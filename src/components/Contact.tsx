      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
        ...
        <FadeUp delay={0.15}>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.75rem' }}>
            <a href="https://github.com/KartikKumbhar" target="_blank" rel="noopener noreferrer" className="social-icon" style={{ width: 44, height: 44 }} aria-label="GitHub">
              <GitHubIcon size={19} />
            </a>
            <a href="https://linkedin.com/in/kartik-kumbhar" target="_blank" rel="noopener noreferrer" className="social-icon" style={{ width: 44, height: 44 }} aria-label="LinkedIn">
