...
const contactLinks = [
  {
    ...
    label: 'Email',
    value: 'kumbharkartik150@gmail.com',
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="contact" ref={ref}>
      <div className="orb orb-blue contact__orb--1" />
      <div className="orb orb-violet contact__orb--2" />
        ...
        >
          <div className="contact__header">
            ...
            <p className="contact__desc">
              I&apos;m open to full-time roles, research collaborations, internships, 
              and interesting projects. Whether you want to discuss tech, build something 
              amazing, or just say hi — my inbox is always open.
            </p>
          </div>
          ...
          >
            <span className="contact__cta-icon">✉️</span>
            Say Hello
          ...
          <div className="contact__links">
            {contactLinks.map((link, i) => (
              <motion.a
                key={link.label}
                href={link.href}
                className={`contact__link glass-card contact__link--${link.color}`}
                ...
                whileHover={{ y: -4 }}
              >
                <span className={`contact__link-icon contact__link-icon--${link.color}`}>
                  {link.icon}
                </span>
