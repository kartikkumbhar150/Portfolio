...
const achievements = [
  {
    ...
    prize: '€3,000',
    description: 'Won the international Allianz Tech Championship against 200+ teams from across Europe and Asia. Built an AI-powered ESG risk analytics dashboard using generative AI and real-time data pipelines.',
  ...
  },
  {
    ...
    prize: null,
    description: 'Runner-up in the Technology Grand Infusion Challenge, a national-level hackathon focused on innovative software solutions for real-world problems.',
    photos: [],
    link: null,
  },
  {
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, padding: '2rem', overflowY: 'auto', position: 'relative' }}>
            ...
            <p style={{ fontSize: '0.9rem', color: 'rgba(0,0,0,0.65)', lineHeight: 1.75, marginBottom: '1.25rem' }}>
              {item.description}
            </p>
            {item.link && (
